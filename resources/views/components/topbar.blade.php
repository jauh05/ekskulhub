<header class="fixed top-0 right-0 w-full md:w-[calc(100%-16rem)] z-10 glass-nav border-b border-outline-variant flex justify-between items-center px-4 md:px-8 h-16 transition-all duration-300">
