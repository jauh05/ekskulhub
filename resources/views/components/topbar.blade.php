...
<button @click="sidebarOpen = !sidebarOpen" style="width: 40px; height: 40px; align-items: center; justify-content: center; z-index: 50;" class="hidden md:flex text-on-surface-variant hover:bg-surface-container-high rounded-full transition-colors">
